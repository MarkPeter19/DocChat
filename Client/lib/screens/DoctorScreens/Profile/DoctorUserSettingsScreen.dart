...
class DoctorUserSettingsScreen extends StatefulWidget {
  const DoctorUserSettingsScreen({super.key});

  @override
  _DoctorUserSettingsScreen createState() =>
      _DoctorUserSettingsScreen();
}

class _DoctorUserSettingsScreen extends State<DoctorUserSettingsScreen> {
